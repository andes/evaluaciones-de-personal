...
router.get('/tipo-cierre-evaluacion', async (req, res) => {
    try {
...
router.get('/tipo-cierre-evaluacion/:id', async (req, res) => {
    try {
        const { id } = req.params;
...
router.post('/tipo-cierre-evaluacion', async (req, res) => {
    try {
...
router.put('/tipo-cierre-evaluacion/:id', async (req, res) => {
    try {
        const { id } = req.params;
