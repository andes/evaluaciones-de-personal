(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-observe', ['exports', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['ngx-observe'] = {}, global.ng.core, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var NgxObserve = /** @class */ (function () {
        function NgxObserve(view, changes, nextTemplateRef) {
            ...
            this.init = new rxjs.AsyncSubject();
        ...
        Object.defineProperty(NgxObserve.prototype, "ngxObserve", {
            set: function (source) {
                ...
                if (source && source !== this.source) {
                    ...
                    this.init.pipe(operators.concatMap(function () {
                        ...
                        return source;
                    }), operators.takeUntil(this.unsubscribe)).subscribe(function (value) {
                        _this.view.clear();
                        _this.errorViewRef = undefined;
    ...
    exports.NgxObserve = NgxObserve;
    exports.NgxObserveModule = NgxObserveModule;
    exports.ObserveContext = ObserveContext;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-observe.umd.js.map
