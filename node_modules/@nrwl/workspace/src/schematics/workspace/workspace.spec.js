...
describe('workspace', () => {
    ...
    it('should create nx.json', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_1.runSchematic('workspace', { name: 'proj' }, projectTree);
    ...
    it('should recommend vscode extensions', () => __awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testing_1.runSchematic('workspace', { name: 'proj' }, projectTree);
    ...
    it('should recommend vscode extensions (angular)', () => __awaiter(void 0, void 0, void 0, function* () {
