...
const check_project_exists_1 = require("./lib/check-project-exists");
...
function default_1(schema) {
    return schematics_1.chain([
        ...
        update_workspace_1.updateWorkspace(schema) // Have to do this last because all previous rules need the information in here
    ]);
}
