...
class DefaultReporter {
    ...
    printResults(affectedArgs, failedProjectNames, startedWithFailedProjects, cachedProjectNames) {
        ...
        if (cachedProjectNames.length > 0) {
            const bodyLines = cachedProjectNames.map(project => `${output_1.output.colors.gray('-')} ${project}`);
