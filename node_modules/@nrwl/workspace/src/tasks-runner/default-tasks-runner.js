...
function runAllTasks(tasks, options, context) {
    return __awaiter(this, void 0, void 0, function* () {
        const stages = new task_orderer_1.TaskOrderer(context.target, context.projectGraph).splitTasksIntoStages(tasks);
        const orchestrator = new task_orchestrator_1.TaskOrchestrator(context.projectGraph, options);
        const res = [];
