...
function runOne(opts) {
    const { nxArgs, overrides } = utils_1.splitArgsIntoNxArgsAndOverrides(Object.assign(Object.assign({}, opts.parsedArgs), { configuration: opts.configuration, target: opts.target, _: [] }), 'run-one');
    ...
    run_command_1.runCommand(projects, projectGraph, env, nxArgs, overrides, reporter);
}
