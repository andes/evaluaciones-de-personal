...
const community_plugins_1 = require("../utils/community-plugins");
...
function listPlugins() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const alsoAvailable = plugins_1.approvedPlugins.filter(p => !installedPluginsMap.has(p.name));
        ...
        yield community_plugins_1.listCommunityPlugins(installedPluginsMap);
        output_1.output.note({
