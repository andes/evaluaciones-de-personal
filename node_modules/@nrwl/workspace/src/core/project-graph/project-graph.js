...
function createProjectGraph(workspaceJson = file_utils_1.readWorkspaceJson(), nxJson = file_utils_1.readNxJson(), workspaceFiles = file_utils_1.readWorkspaceFiles(), fileRead = file_utils_1.defaultFileRead, cache = readCache()) {
    ...
    if (cache && maxMTime(file_utils_1.rootWorkspaceFileData()) > cache.mtime) {
        cache = false;
    }
