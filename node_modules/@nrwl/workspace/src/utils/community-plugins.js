...
const APPROVED_PLUGINS_JSON_URL = 'https://raw.githubusercontent.com/nrwl/nx/master/community/approved-plugins.json';
function fetchCommunityPlugins() {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield axios_1.default.get(APPROVED_PLUGINS_JSON_URL);
        return response.data;
    });
}
function listCommunityPlugins(installedPluginsMap) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const communityPlugins = yield fetchCommunityPlugins();
