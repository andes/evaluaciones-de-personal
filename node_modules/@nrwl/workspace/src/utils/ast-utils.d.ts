...
export declare function insert(host: Tree, modulePath: string, changes: any[]): void;
/**
...
export declare function getFileDataInHost(host: Tree, path: Path, mtime: number): FileData;
...
export declare function updateWorkspaceInTree<T = any, O = T>(callback: (json: T, context: SchematicContext) => O): Rule;
export declare function readNxJsonInTree(host: Tree): NxJson<string[] | "*">;
export declare function updateNxJsonInTree(callback: (json: NxJson, context: SchematicContext) => NxJson): Rule;
export declare function addProjectToNxJsonInTree(projectName: string, options: NxJsonProjectConfig): Rule;
