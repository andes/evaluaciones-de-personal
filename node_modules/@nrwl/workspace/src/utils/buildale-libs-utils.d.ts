...
export declare function updatePaths(dependencies: DependentBuildableProjectNode[], paths: {
    [k: string]: string[];
}): void;
/**
 ...
 */
export declare function updateBuildableProjectPackageJsonDependencies(context: BuilderContext, node: ProjectGraphNode, dependencies: DependentBuildableProjectNode[]): void;
