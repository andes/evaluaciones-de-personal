...
function getProjectGraphFromHost(host) {
    ...
    return project_graph_1.onlyWorkspaceProjects(project_graph_1.createProjectGraph(workspaceJson, nxJson, workspaceFiles, fileRead, false));
}
...
function updateNxJsonInTree(callback) {
    return (host, context) => {
        host.overwrite('nx.json', fileutils_1.serializeJson(callback(readJsonInTree(host, 'nx.json'), context)));
        return host;
    };
}
