...
function printGenHelp(opts, schema, logger) {
    print_help_1.printHelp(`${print_help_1.commandName} generate ${opts.collectionName}:${opts.schematicName}`, Object.assign(Object.assign({}, schema), { properties: Object.assign(Object.assign({}, schema.properties), { dryRun: `Runs through and reports activity without writing to disk.` }) }), logger);
}
